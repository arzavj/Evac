(function($) {
    var NivoSlider = function(element, options){
        ...
        // Get this slider
        var slider = $(element);
		slider.css({overflow:'hidden', '-webkit-border-radius': settings.borderRadius + 'px', '-moz-border-radius': settings.borderRadius + 'px', 'border-radius': settings.borderRadius + 'px'});
		...
		sliderImg.css({'-webkit-border-radius': settings.borderRadius + 'px', '-moz-border-radius': settings.borderRadius + 'px', 'border-radius': settings.borderRadius + 'px'});
